...
- Write-ready rows preserve every source-language variant and include evidence-backed `en` values for every TIDAS-required multilingual field. Optional additional-language completion remains a separate post-import task.
