...
lastReviewedNote: "Reviewed for Issue #76: verified-scope pruning requires self-verifying CAS receipts and ownership-safe explicit dispositions."
tracker:
  kind: filesystem
  inbox: tasks/inbox
  active: tasks/active
